...
module Releases
  ...
  RELEASE_SOURCE  = 'https://review.beachos.org/BeachOS/release'
  HASHES_SOURCE   = 'https://review.beachos.org/BeachOS/releases'
  RELEASE_DL_BASE = 'https://release.beachinstitute.org/'
  ...
  class << self
    ...
    def get_version_from(build_number)
      # https://gitlab.com/BeachOS/vendor_beach/-/blob/android13/config/version.mk
