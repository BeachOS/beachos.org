...
The official BeachOS builds are signed with our private keys.
...
Starting July 2021, all BeachOS factory images will be signed using [minisign](https://jedisct1.github.io/minisign/)
...
You'll also need the public key, [minisign.pub](https://release.beachinstitute.org/minisign.pub)
