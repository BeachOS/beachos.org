...
* **Factory Image**: This is a zip file that contains the entire BeachOS operating system to be installed on your device.
...
* **Android Device**: The device that you are installing BeachOS on to.
* **Host Computer**: The Windows computer used to send commands to the Android Device. You will connect this computer to the Android device and run device-flasher to install BeachOS.
...
<a class="btn" href="https://release.beachinstitute.org/crosshatch-factory-22405000.zip">Download BeachOS Image</a>
...
{% assign image = "https://release.beachinstitute.org/crosshatch-factory-22405000.zip" | split: "/" | last %}
...
For the highest level of confidence, you can optionally <a href="https://release.beachinstitute.org/crosshatch-factory-22405000.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].

## Install BeachOS

### Run device-flasher

Now you are ready to install. Ensure that both the BeachOS image and device-flasher are in the same directory.
...
Once device-flasher is finished, you should now have a fully functional BeachOS device. If not, please see our [[community]] page for where you can post your questions.
