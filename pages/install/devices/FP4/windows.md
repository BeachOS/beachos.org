...
<a class="btn" href="https://release.beachinstitute.org/FP4-factory-22405000.zip">Download BeachOS Image</a>
...
{% assign image = "https://release.beachinstitute.org/FP4-factory-22405000.zip" | split: "/" | last %}
...
For the highest level of confidence, you can optionally <a href="https://release.beachinstitute.org/FP4-factory-22405000.zip.minisig">download the signature file</a> and then [[verify image signature => verify]].
