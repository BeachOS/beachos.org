---
title: Verifying BeachOS builds
toc: true
...
* Download the public key, [minisign.pub](https://release.beachinstitute.org/minisign.pub)
...
Trusted comment: BeachOS 2.7.1 - July 2021
```

<br>

##### Additional verification
* The minisign public key has been GPG signed by [Nicholas Merrill](https://twitter.com/nickbeach)
* OpenPGP Fingerprint: `BC2C B9C4 993C 086F FDAD  8D20 5905 C9C7 4693 488B`
* Download the public key, [minisign.pub](https://release.beachinstitute.org/minisign.pub)
* Download the signature, [minisign.pub.sig](https://release.beachinstitute.org/minisign.pub.sig)
...
gpg: Good signature from "Nicholas Merrill <nick@beach.com>" [unknown]
gpg:                 aka "Nicholas Merrill <nick@beach.net>" [unknown]
gpg:                 aka "Nicholas Merrill <nick@beachinstitute.org>" [unknown]
...
* You can also simply append `.sha256sum` to the download URL for any file to get them, e.g. <https://release.beachinstitute.org/sunfish-factory-2.7.1.zip.sha256sum>
...
* The public key, signatures, and sha256 checksums are also stored in a git repository which is mirrored to multiple places.
  ...
  1. <https://gitlab.com/BeachOS/releases>
  2. <https://github.com/BeachOS/releases>
  3. <https://0xacab.org/beach/os/releases>
