...
Clone git repo:
    ...
    git clone https://gitlab.com/BeachOS/beachos.org.git -b main
...
The 'main' branch of this git repository is automatically deployed to <https://beachos.org>

It is automatically deployed to <https://beachos.gitlab.io/beachos.org/>

## Development

Development is done on [Gerrit](https://review.beachos.org/q/project:BeachOS%252Fbeachos.org) - for more details see the [contribution guide](https://beachos.org/development/gerrit/)

## External Sources

Data from these places are pulled in to help generate this site:

* https://gitlab.com/BeachOS/release.git
* https://gitlab.com/BeachOS/releases.git
* https://gitlab.com/BeachOS/platform_prebuilts_beach_fdroid/-/raw/android13/repo/index-v1.json
...
* `--beach-light`: `rgba(154, 202, 60, 1)` aka `#9ACA3C`
* `--beach-base`: `rgba(98, 128, 38, 1)` aka `#628026`
* `--beach-dark`: `rgba(78, 102, 31, 1)` aka `#4E661F`
